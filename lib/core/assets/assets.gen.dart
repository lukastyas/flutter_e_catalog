...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/catalog.png
  AssetGenImage get catalog => const AssetGenImage('assets/icons/catalog.png');
  ...
  /// File path: assets/icons/company.png
  AssetGenImage get company => const AssetGenImage('assets/icons/company.png');
  ...
  /// File path: assets/icons/sheet.png
  AssetGenImage get sheet => const AssetGenImage('assets/icons/sheet.png');
...
class $AssetsImagesGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values =>
      [finish, imgSuccess, logicTest, logo, materi1, materi2, quizCategory];
}
